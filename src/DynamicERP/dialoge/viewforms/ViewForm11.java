 ...
 * @author DynamicSP
 */
public class ViewForm11 extends javax.swing.JFrame implements KeyListener {
   ...
   public String getSearchFieldText() {
    ...
    public ViewForm11(String col[],String string) {
...
//        jTable1.getColumnModel().getColumn(7).setPreferredWidth(50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewForm11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewForm11(null,null).setVisible(true);
            }
        });
    }
