 ...
 * @author Shan
 */
public class PAK_VOUCHR_DB extends PAK_GLOBAL_DB{
    public ArrayList<String> get_last_purchase(Connection conn) throws SQLException {
        ...
        String Sql = "select * from VOCMAIN WHERE DOCNO="+max;
    ...
    public String[][] search_vouchers(Connection conn, String distrec) throws SQLException {
//        /*
        String returned[][] = new String[find_count_in_purchase(conn)][6];
	java.sql.Statement statement = conn.createStatement();
	String Sql = "Select * from VOCMAIN";
       ...
       try
        {
            ...
            Sql="SELECT * FROM VOCMAIN WHERE DOCNO > "+Integer.parseInt(code)+" ORDER BY DOCNO";            
            ResultSet result = null;
            result=statement.executeQuery(Sql);
//            //System.out.println("Result : " + result);
       ...
       try
        {
            ...
            Sql="SELECT * FROM VOCMAIN WHERE DOCNO <"+Integer.parseInt(code)+" ORDER BY DOCNO DESC ";
...
//            //System.out.println("Result : " + result);
     ...
     public ArrayList<String> get_first_purchase(Connection conn)throws SQLException {
        ...
        if(min!=0){
            String Sql;
            Sql = "select * from VOCMAIN WHERE DOCNO="+min;//+"AND CREDITAMOUNT > "+Integer.parseInt("0");
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            //System.out.println("Result : " + result);
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM VOCMAIN WHERE DOCNO = "+code;
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM VOCDTL WHERE DOCNO = '"+docno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM VOCDTL WHERE DOCNO = '"+docno+"' AND SEQNO = '"+seqno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
    ...
    public ArrayList<String> find_purchase_by_code(Connection conn,String code) throws SQLException {
        java.sql.Statement statement = conn.createStatement();
        String Sql = "select * from VOCMAIN WHERE DOCNO="+code;
...
//        //System.out.println("Result : " + result);
    ...
    public boolean update_purchase(Connection conn, String docno,String odate,String refno,String descr,String td,String tc){
        ...
        try
        {
            ...
            String Sql;
//            DOCNO,ODATE,REFNO,DESCR,TD,TC
             Sql="UPDATE VOCMAIN SET  REFNO = '"+refno+"', ODATE= TO_DATE('" + odate +
    ...
    public int find_max_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT MAX(SEQNO) AS Count FROM VOCDTL WHERE  DOCNO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
    ...
    public boolean insert_purchase_in_table(Connection conn,String docno,String odate,String refno,String descr,String td,String tc){
        ...
        try
        {
            ...
            String Sql = "INSERT INTO VOCMAIN(DOCNO,ODATE,REFNO,DESCR,TD,TC) VALUES ("
	...
	java.sql.Statement statement = conn.createStatement();
//         SELECT * FROM VOCDTL WHERE  DOCNO = 90002 ORDER BY SEQNO ASC
	String Sql = "SELECT * FROM VOCDTL WHERE  DOCNO = '"+asset_rec+"' ORDER BY SEQNO ASC";
	ResultSet resultset = statement.executeQuery(Sql);
        int i=0;
        while(resultset.next())
        {
     ...
     public int find_count_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(SEQNO) AS Count FROM VOCDTL WHERE  DOCNO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
     ...
     public int find_count_in_purchase(Connection conn) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(DOCNO) AS Count FROM VOCMAIN";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
...
//            DOCNO,ACCODE,TYPE,AMOUNT,SEQNO
                java.sql.Statement statement = conn.createStatement();
                String Sql;
                    Sql="UPDATE VOCDTL SET SEQNO= '"+seqno+"', DEBIT = '"+amount+"', TYPE = '"+type+"',CREDIT = '"+credit+"', ACCODE = '"+accode+
...
//            }
    ...
    public boolean check_product_line_item_presence_new(Connection conn,String string, String seqNoText,int pc) {
        ...
        try {
            ...
            String Sql = "select * from VOCDTL ";
            result=statement[Integer.parseInt(seqNoText)].executeQuery(Sql);
            Sql = "select * from VOCDTL WHERE (DOCNO='"+string+"') AND (SEQNO='"+seqNoText+"') ";
    ...
    public int find_max_in_purchase_code(Connection conn) {
        ...
        return max;
    }public boolean insert_finance_ledger(Connection conn,String  custcode,String docdate,String descr,String debit,String credit,String docno) {
        boolean var = false;
        try
        {
            java.sql.Statement statement = conn.createStatement();
                String Sql = "INSERT INTO FINLEG(CUSTCODE,DOCDATE,DESCR,DEBIT,CREDIT,DOCNO) VALUES ("+
    ...
    public boolean insert_purchase_products_in_table(Connection conn,String docno,String accode,String type,String amount,String seqno,String credit){
        ...
        try
        {
            ...
            String Sql = "INSERT INTO VOCDTL(DOCNO,ACCODE,TYPE,DEBIT,SEQNO,CREDIT) VALUES ('"
...
//                cat=getPurchase(result);
            ...
            Logger.getLogger(PAK_VOUCHR_DB.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cat;
    }
    ...
    public String find_product_name_by_code(Connection conn, String code) throws SQLException {
        ...
        if(result.next()){
            ...
            System.out.println("result.getString(\"FINNAME\")"+result.getString("FINNAME"));
        }else{
            cat=null;
        }
        return cat;
    ...
    public String find_product_rec_by_code(Connection conn, String code) throws SQLException {
        java.sql.Statement statement = conn.createStatement();
        String Sql = "select FINNAME from FINANCE WHERE CODE='"+code+"'";
    ...
    private ArrayList<String> getRecords(ResultSet result) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select * from FINLEG WHERE DOCNO='"+docno+"' AND DESCR  LIKE '"+seqNoText+"%'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
...
//                    System.out.println("MATCHED======with====="+seqNoText);
   ...
   public boolean update_suppleg_ledger(Connection conn,String  custcode,String docdate,String descr,String debit,String credit,String docno,String docno1) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql="UPDATE FINLEG SET  CUSTCODE = '"+custcode+"', DOCDATE= TO_DATE('" + docdate +
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM FINLEG WHERE DOCNO = '"+docno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//            String s ="Seq # "+seqno+" Ref #";
            Sql = "DELETE FROM FINLEG WHERE DOCNO = '"+docno+"' AND DESCR  = '"+seqno+"'"; 
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
    ...
    public String get_clbal_from_finance(Connection conn, String code) {
        String  cat=null;
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select CLBAL from FINANCE WHERE CODE='"+code+"'";
    ...
    public boolean update_clbal_in_finance(Connection conn, String b, String docno) {
        boolean var = false;
        try
        {
            java.sql.Statement statement = conn.createStatement();
            ...
            Sql="UPDATE FINANCE SET  CLBAL = '"+b+"'WHERE CODE ="+docno;
            statement.executeUpdate(Sql);
    ...
    public String[] get_accode_type_debit_credit(Connection conn, String s1, String s2) {
        String cat[] = new String[4];
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select ACCODE,TYPE,DEBIT,CREDIT from VOCDTL WHERE DOCNO ='"+s1+"' AND SEQNO ="+s2;
