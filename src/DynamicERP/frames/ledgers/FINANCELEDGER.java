 ...
 * @author Shan
 */
public class FINANCELEDGER extends javax.swing.JFrame {
    ...
    */
    public FINANCELEDGER() {
        ...
        try {
            ...
            Logger.getLogger(FINANCELEDGER.class.getName()).log(Level.SEVERE, null, ex);
        }try {
                connAA = dataAA.connect_database();
        ...
        try {
            ...
            if(setSelectedComboItem(custCode,custR,((!custCode.getText().isEmpty())?data.find_fin_name_by_code(conn, custCode.getText()):""))){
    ...
    private void initComponents() {
            ...
            .addGroup(jpanspecificationsLayout.createSequentialGroup()
                ...
                .addGroup(jpanspecificationsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpanspecificationsLayout.createSequentialGroup()
                        ...
                        .addComponent(custR, 0, 414, Short.MAX_VALUE))
                    .addComponent(add))
                .addGap(18, 18, 18)
                .addGroup(jpanspecificationsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jpanspecificationsLayout.createSequentialGroup()
            ...
            .addGroup(jpanspecificationsLayout.createSequentialGroup()
                .addGroup(jpanspecificationsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpanspecificationsLayout.createSequentialGroup()
                        ...
                        .addGap(1, 1, 1)
                        .addGroup(jpanspecificationsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jLabel4.setText("Finance Ledger");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        PAK_FINLED_DB data = new PAK_FINLED_DB();
        Connection conn;
        try {
            conn = data.connect_database();
            String[][] r = null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            jButton1.doClick();
            String s= "D:\\Oracle DMS software\\MarblePRO\\src\\MarblePRO\\reports\\legers\\legers_1.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FINANCELEDGER.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FINANCELEDGER().setVisible(true);
            }
        });
    }
    ...
    private void initTable(String[][] rowData) {
        String col[] = {"Sr. #", "DocNo", "Date", "Desc", "Debit", "Credit", "Balance"};
        String row[][] = rowData;
    ...
    private String getCode(String name) {
        ...
        try {
            conn = data.connect_database();
            if(!name.equals("")){
                s=data.find_fin_desc_by_name(conn,name.trim());
                add.setText(s);
    ...
    public static DefaultComboBoxModel buildAllComboBoxModel() throws Exception {
     ...
     public DefaultComboBoxModel buildOneComboBoxModel(String id) throws Exception {
        ...
        if(!id.equals("")){
            ...
            element=data.find_fin_desc_by_name(conn,element);
            add.setText(element);
        }
        data.close_database(conn);
        return comboBoxModel;
