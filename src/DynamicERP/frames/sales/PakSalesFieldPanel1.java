 ...
 * @author Shan
 */
public class PakSalesFieldPanel1 extends javax.swing.JPanel {
...
//        KeyboardFocusManager.getCurrentKeyboardFocusManager().setDefaultFocusTraversalKeys(KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS, keys);
        ...
        if(has_access((new EcLogger()).classDeLoade(lineL[0]),"202")){
            fmr.setVisible(true);
            fmrrs.setVisible(true);
        }else{
            fmr.setVisible(false);
            fmrrs.setVisible(false);
        }    
    ...
    private void initComponents() {
        ...
        pName2 = new javax.swing.JComboBox();
        ...
        ordSeqNo = new javax.swing.JTextField();
        ordDocNo = new javax.swing.JTextField();
        ...
        pName2.setFont(new java.awt.Font("Calibri", 1, 11)); // NOI18N
        pName2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Chocorama Van Rs 5 1 x 12 Box", "Item 3", "Item 4" }));
        pName2.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                pName2ItemStateChanged(evt);
            }
        });
        pName2.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {
                pName2PopupMenuWillBecomeVisible(evt);
            }
        });
        ...
        setPreferredSize(new java.awt.Dimension(1136, 20));
        ...
        totalQty.setText("0");
        totalQty.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                totalQtyCaretUpdate(evt);
            }
        });
        ...
        ordSeqNo.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ordSeqNo.setText("0");
        ordSeqNo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ordSeqNoActionPerformed(evt);
            }
        });
        ordSeqNo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                ordSeqNoKeyReleased(evt);
            }
        });

        ordDocNo.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ordDocNo.setText("0");
        ordDocNo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ordDocNoActionPerformed(evt);
            }
        });
        ordDocNo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                ordDocNoKeyReleased(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(seqNo, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(ordDocNo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(ordSeqNo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                ...
                .addGap(0, 0, 0)
                .addComponent(ctn, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(pcs, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                ...
                .addGap(0, 0, 0)
                .addComponent(tdo, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
...
//            }
    ...
    private void ordSeqNoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ordSeqNoKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_ordSeqNoKeyReleased

    private void ordDocNoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ordDocNoKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_ordDocNoKeyReleased

    private void ordSeqNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ordSeqNoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ordSeqNoActionPerformed
    ...
    private void ordDocNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ordDocNoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ordDocNoActionPerformed
    ...
    private void totalQtyCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_totalQtyCaretUpdate
        
    }//GEN-LAST:event_totalQtyCaretUpdate
    ...
    private void DatePopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_DatePopupMenuWillBecomeVisible
        ...
        try {
            Date.setModel(buildAllDtlComboBoxModel("date",seek.getText(),(Date.getSelectedItem()!=null?Date.getSelectedItem().toString():""),connAA));
    ...
    private void pName2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_pName2ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_pName2ItemStateChanged
    
    private void pName2PopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_pName2PopupMenuWillBecomeVisible
        PAK_DB data =new PAK_DB();
        
        try {
                    
            
//            pName2.setModel(buildAllDtlComboBoxModel("custome",seek.getText(),(Date.getSelectedItem()!=null?Date.getSelectedItem().toString():"000")));
            pName2.setModel(buildAllDtlComboBoxModel("custome",seek.getText(),(Date.getSelectedItem()!=null?Date.getSelectedItem().toString():""),connAA));
    ...
    }//GEN-LAST:event_pName2PopupMenuWillBecomeVisible
    ...
    private void seekCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_seekCaretUpdate
        try {
            ...
            Logger.getLogger(PakSalesFieldPanel1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private javax.swing.JTextField ordDocNo;
    private javax.swing.JTextField ordSeqNo;
    private javax.swing.JTextField pName;
    private javax.swing.JComboBox pName2;
    ...
    public JComboBox getpName2() {
        return pName2;
    }

    public void setpName2(JComboBox pName2) {
        this.pName2 = pName2;
    }
    ...
    public JTextField getOrdDocNo() {
        return ordDocNo;
    }

    public void setOrdDocNo(JTextField ordDocNo) {
        this.ordDocNo = ordDocNo;
    }

    public JTextField getOrdSeqNo() {
        return ordSeqNo;
    }

    public void setOrdSeqNo(JTextField ordSeqNo) {
    ...
    public static DefaultComboBoxModel buildAllDtlComboBoxModel(String c,String c1,String c2,Connection cc) throws Exception {
        ...
        try {
            ...
            switch(c){
                case "date":
                    elements=data.find_all_date_by_product_code(cc,c1);
                    break;
                case "custome":
                    elements=data.find_all_custome_by_product_code(cc,c1,c2);
                    break;
            }
            if(elements!=null){    
    ...
    /*
    public static DefaultComboBoxModel buildAllComboBoxModel(Connection cc) throws Exception {
        DefaultComboBoxModel comboBoxModel = new DefaultComboBoxModel();
        PAK_DB data =new PAK_DB();
        ...
        try {
            ...
            boolean tf=false;
            elements=data.find_all_product_name_size_by_code(cc);
            if(elements!=null){    
                for(String s : elements){
                    comboBoxModel.addElement(s);
                }
    ...
    public String buildOneComboBoxModel(String id) throws Exception {
        ...
        try {
            ...
            if(!id.equals("")){
                temp=data.find_product_rec_by_code(connAA, id);
    ...
    private String getCode(String name) {
        ...
        try {
            ...
            if(!name.equals("")){
                s=data.find_product_code_by_name(connAA,name);
//                s=data.find_product_code_by_name(connAA,name);
            }else{
//                JFrame j=new JFrame();
//                j.setAlwaysOnTop(true);
    ...
    */
    ...
    private String getRate(String name) {
        ...
        try {
            ...
            if(!name.equals("")){
                s=data.find_product_rate_by_name(connAA,name);
            }else{
//                JFrame j=new JFrame();
//                j.setAlwaysOnTop(true);
//                JOptionPane.showMessageDialog(j, "Emter Id Found");
    ...
    private String getWeight(String name) {
        ...
        try {
            ...
            if(!name.equals("")){
                s=data.find_product_weight_by_name(connAA,name.trim());
            }else{
//                JFrame j=new JFrame();
//                j.setAlwaysOnTop(true);
//                JOptionPane.showMessageDialog(j, "Emter Id Found");
    ...
    public void textFieldsEditableProducts(boolean b) {
        seqNo.setEditable(false);
        ordDocNo.setEditable(false);
        ordSeqNo.setEditable(false);
        ctn.setEditable(b);
        pcs.setEditable(b);
    ...
    public void textFieldsEditableProducts1(boolean b) {
        totalQty.setEditable(b);
        customeSize.setEditable(b);
        rate.setEditable(b);
        grossAmt.setEditable(b);
...
//                System.out.println("Number Format is InCorrect: "+ex.getMessage());
    ...
    public void frmDiscRs() {
        ...
        if(has_access((new EcLogger()).classDeLoade(lineL[0]),"101")){
            try{
...
//        /*
        ...
        if(has_access((new EcLogger()).classDeLoade(lineL[0]),"102")){
            try{
...
//        frmDiscRs();
    ...
    public String getNoOfPcsInCtn() {
        ...
        PAK_GENERAL_DB data= new PAK_GENERAL_DB();
        try{
            s=data.getNoOfPcsInCtn(connAA,seek.getText());
