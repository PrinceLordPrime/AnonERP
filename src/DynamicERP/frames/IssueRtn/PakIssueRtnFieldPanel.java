...
import DynamicERP.frames.issueSales.PakIsSalesFieldPanel1;
 ...
 * @author Shan
 */
public class PakIssueRtnFieldPanel extends javax.swing.JPanel {
...
//        KeyboardFocusManager.getCurrentKeyboardFocusManager().setDefaultFocusTraversalKeys(KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS, keys);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1257, 20));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(totalQty, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(returnQty, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(totalQty33, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
...
/*        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
    ...
    private void seekCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_seekCaretUpdate
        try {
            ...
            Logger.getLogger(PakIssueRtnFieldPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public String buildOneComboBoxModel(String id) throws Exception {
        String string = "";//new DefaultComboBoxModel();
        PAK_DB data =new PAK_DB();
        Connection conn;
        String element="";
        try {
