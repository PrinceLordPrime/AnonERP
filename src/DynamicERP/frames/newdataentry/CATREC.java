 ...
 */
public class CATREC extends javax.swing.JFrame {

    /**
     * Creates new form CATREC
     */
    public CATREC() {
        initComponents();
        ...
        try {
            ...
            ArrayList<String> stock = data.get_first_cat(conn);
            if(stock != null)
            {
                code.setText(stock.get(0));
                cat.setText(stock.get(1));
            }else{
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Product Category Records");
...
//        /*
        ...
        if(isSaved){
            code.setText(dialogeClass.codeCatRec);
            cat.setText(dialogeClass.catRec);
        }else{
            //            JFrame j=new JFrame();
//                    j.setAlwaysOnTop(true);
...
//        */
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        DynamicERP.dialoge.newdataentry.dialogeClass.disposeCatRecWin();
    ...
    if(!(code.getText().toString().equalsIgnoreCase(""))){
        ...
        try {
            conn = data.connect_database();
            String s=data.find_cat_rec_by_code(conn, code.getText());
            if (s!=null){
                cat.setText(s);
                code.setEditable(false);
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        try {
            ...
            Connection conn;
            conn = data.connect_database();
            if(data.check_catrec_code_presence_in_pmast(conn,code.getText())){
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
                ...
                { //ConfermationDiloge()){
                    ...
                    boolean tf=false;
                    if(code.getText()==null||cat.getText()==null){

                    }else{
                        tf=data.delete_cat(conn,code.getText(),cat.getText());
                    }
                    if(tf){
                        cat.setText("");
                        code.setText("");
            ...
            Logger.getLogger(CATREC.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(!(cat.getText().toString().equalsIgnoreCase(""))){
            PAK_DB data =new PAK_DB();
            Connection conn;
            try {
                conn = data.connect_database();
                ...
                ///Max
                int max=0,codeInt=0;
                max=data.find_max_in_cat_code(conn);
                ...
                tf=data.insert_cat_in_table(conn,String.valueOf(codeInt),cat.getText());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            conn = data.connect_database();
            boolean tf=false;
            tf=data.update_cat(conn,code.getText(),cat.getText());
            if(tf){
                cat.setEditable(false);
                forBackBtnEnable(true);
                recEditBtnEnable(true);
    ...
    private void btnPriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPriorActionPerformed
        ...
        try {
            ...
            prior=data.prior_cat(conn,code.getText(),cat.getText());
            if(!(prior==null)){
                code.setText(prior.get(0));
                cat.setText(prior.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        try {
            ...
            next=data.next_cat(conn,code.getText(),cat.getText());
            if(!(next==null)){
                code.setText(next.get(0));
                cat.setText(next.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CATREC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void setLastRec() {
        ...
        try {
            conn = data.connect_database();
            ArrayList<String> stock = data.get_last_cat(conn);
            if(stock.get(0)==null){
                code.setText("");
                cat.setText("");
            }else{
