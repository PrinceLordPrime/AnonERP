 ...
 * @author Shan
 */
public class PakSalesOrderFieldPanel extends javax.swing.JPanel {

    /**
     * Creates new form PakPurchaseFieldPanel
     */
    public PakSalesOrderFieldPanel() {
        initComponents();
        styleComboBox(pName);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(customSize, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
    ...
    private void seekKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_seekKeyReleased
        if((evt.getKeyCode() == KeyEvent.VK_ENTER) && seek.getText().isEmpty()) {
            ...
            totalQty.requestFocus();totalQty.selectAll();
        }
...
/*        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
    ...
    private void grossAmtKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_grossAmtKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_grossAmtKeyTyped
    ...
    public JTextField getCustSize() {
        return customSize;
    }

    public void setCustSize(JTextField custSize) {
        this.customSize = custSize;
    }
