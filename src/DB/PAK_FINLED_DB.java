 ...
 * @author Shan
 */
public class PAK_FINLED_DB extends PAK_GLOBAL_DB{
...
//        float l=0.0f;
    ...
    public int find_count_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(FINANCECODE) AS Count FROM FINANCELEGER WHERE FINANCECODE = '"+name+"'";
...
//     
//        try {
////            FINANCECODE,DOCDATE,DESCRIPTION,DEBIT,CREDIT
//            
//                cat.add(0,code );
//                cat.add(1,c );
//                cat.add(2,co );
...
//    }
    ...
    private int find_count_in_result(Connection conn, String asset_rec,String ddate,String cdate) {
        ...
        try {
            ...
            Logger.getLogger(PAK_FINLED_DB.class.getName()).log(Level.SEVERE, null, ex);
        }
        return count;
    }
