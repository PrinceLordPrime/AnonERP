 ...
 * @author Shan
 */
public class PAK_SCHPROCATPRO_DB extends PAK_GLOBAL_DB{
    public ArrayList<String> get_last_purchase(Connection conn) throws SQLException {
        ...
        String Sql = "select * from SCHPROCATPRO WHERE TONO="+max;
...
//        /*
	...
	java.sql.Statement statement = conn.createStatement();
	String Sql = "Select * from SCHPROCATPRO";
       ...
       try
        {
            ...
            Sql="SELECT * FROM SCHPROCATPRO WHERE TONO > "+Integer.parseInt(code)+" ORDER BY TONO";            
            ResultSet result = null;
            result=statement.executeQuery(Sql);
//            //System.out.println("Result : " + result);
       ...
       try
        {
            ...
            Sql="SELECT * FROM SCHPROCATPRO WHERE TONO <"+Integer.parseInt(code)+" ORDER BY TONO DESC ";
...
//            //System.out.println("Result : " + result);
     ...
     public ArrayList<String> get_first_purchase(Connection conn)throws SQLException {
        ...
        if(min!=0){
            String Sql;
            Sql = "select * from SCHPROCATPRO WHERE TONO="+min;//+"AND CREDITAMOUNT > "+Integer.parseInt("0");
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            //System.out.println("Result : " + result);
     ...
     public int find_min_in_purchase_code(Connection conn) {
        ...
        try
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql;
                Sql = "Select MIN(TO_NUMBER(TONO))as ID from SCHPROCATPRO ";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHPROCATPRO WHERE TONO = "+code;
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHPROCATPRO WHERE TONO = '"+docno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHPROCATPRO WHERE TONO = '"+docno+"' AND SRNO = '"+seqno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//            String s ="Seq # "+seqno+" Ref #";
    ...
    public ArrayList<String> find_purchase_by_code(Connection conn,String code) throws SQLException {
        java.sql.Statement statement = conn.createStatement();
        String Sql = "select * from SCHPROCATPRO WHERE TONO="+code;
...
//            TONO,ODATE,REFNO,DESCR,TD,TC
             Sql="UPDATE SCHPROCATPRO SET  REFNO = '"+refno+"', ODATE= TO_DATE('" + odate +
    ...
    public int find_max_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT MAX(SRNO) AS Count FROM SCHPROCATPRO WHERE  TONO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
    ...
    public boolean insert_purchase_in_table(Connection conn,String docno,String odate,String refno,String descr,String td,String tc){
        ...
        try
        {
            ...
            String Sql = "INSERT INTO SCHPROCATPRO(TONO,ODATE,REFNO,DESCR,TD,TC) VALUES ("
	...
	java.sql.Statement statement = conn.createStatement();
//         SELECT * FROM SCHPROCATPRO WHERE  TONO = 90002 ORDER BY SRNO ASC
	String Sql = "SELECT * FROM SCHPROCATPRO WHERE  TONO = '"+asset_rec+"' ORDER BY SRNO ASC";
	ResultSet resultset = statement.executeQuery(Sql);
        int i=0;
        while(resultset.next())
        {
     ...
     public int find_count_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(SRNO) AS Count FROM SCHPROCATPRO WHERE  TONO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
     ...
     public int find_count_in_purchase(Connection conn) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(TONO) AS Count FROM SCHPROCATPRO";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
     ...
     public boolean update_purchase_products_in_table_new(Connection conn,String tono,String subcat,String srno,String odate,String cdate,String stpcs,String endpcs,String unitd,String schrs,String pcode1){
        ...
        try
        {
            ...
            //TONO,SUBCAT,SRNO,ODATE,CDATE,STPCS,ENDPCS,UNITD,SCHRS
                java.sql.Statement statement = conn.createStatement();
                String Sql;
                 Sql="UPDATE SCHPROCATPRO SET TONO= '"+tono+"', SUBCAT = '"+subcat+"', SRNO = '"+srno+"', ODATE= TO_DATE('" + odate +
...
//            }
    ...
    public boolean check_product_line_item_presence_new(Connection conn,String string, String seqNoText,int pc) {
        ...
        try {
            ...
            Sql = "select * from SCHPROCATPRO WHERE (TONO='"+string+"') AND (SRNO='"+seqNoText+"') ";
...
//                    System.out.println("MATCHED======with====="+seqNoText);
      ...
      public int find_max_in_purchase_code(Connection conn) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "Select MAX(TO_NUMBER(TONO))as ID from SCHPROCATPRO";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("ID");
    ...
    public boolean insert_purchase_products_in_table(Connection conn,String tono,String subcat,String srno,String odate,String cdate,String stpcs,String endpcs,String unitd,String schrs,String pcode1){
        ...
        try
        {
            ...
            String Sql = "INSERT INTO SCHPROCATPRO(TONO,SUBCAT,SRNO,ODATE,CDATE,STPCS,ENDPCS,UNITD,SCHRS,PCODE1) VALUES ('"+Float.parseFloat(tono)+"','"
...
//                cat=getPurchaseProducts(result);
            ...
            Logger.getLogger(PAK_SCHPROCATPRO_DB.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cat;
    }
    ...
    public String[] get_accode_type_debit_credit(Connection conn1a, String s4, String s5) {
        ...
        try {
            ...
            String Sql = "select ACCODE,TYPE,DEBIT,CREDIT from SCHPROCATPRO WHERE TONO ="+s4+" AND SRNO ="+s5;
    ...
    public boolean checkDates(Connection conn, String toDateString, String toDateString0, String to, String subcat) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select distinct TONO,ODATE,CDATE  from SCHPROCATPRO WHERE SUBCAT ="+subcat;
    ...
    public boolean checkUpdDates(Connection conn, String toDateString, String toDateString0, String to, String subcat) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select distinct TONO,ODATE,CDATE  from SCHPROCATPRO WHERE SUBCAT ="+subcat+" AND TONO <>"+to;
