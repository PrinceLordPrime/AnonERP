 ...
 * @author DynamicSP
 */
public class ViewForm1 extends javax.swing.JFrame implements KeyListener {
   ...
   public String getSearchFieldText() {
    ...
    public ViewForm1(String col[],String string) {
            ...
            switch(type.toLowerCase()) {
                ...
                case "credit":  
                        r=data.search_credit(conn, getSearchFieldText());
                         break;
                case "scheme":  
                        r=data.search_scheme_rec(conn, getSearchFieldText());
                         break;
                case "schemeqty":  
                        r=data.search_schemeqty_rec(conn, getSearchFieldText());
                         break;
                case "schemeqtypro":  
                        r=data.search_schemeqtypro_rec(conn, getSearchFieldText());
                         break;
                case "schprocatpro":  
                        r=data.search_schprocatpro_rec(conn, getSearchFieldText());
                         break;
                case "schemeprocat":  
                        r=data.search_schemeprocat_rec(conn, getSearchFieldText());
                         break;
                case "slab":  
                        r=data.search_slab_rec(conn, getSearchFieldText());
                         break;
                case "custrec":  
                ...
                case "emprec":  
                        r=data.search_emp_rec(conn, getSearchFieldText());
                         break;
                case "user":  
                        r=data.search_user_rec(conn, getSearchFieldText());
                         break;
                case "productrec":  
...
//        });
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewForm1(null,null).setVisible(true);
            }
        });
    }
    ...
    private void disposeWin() {
        switch(type.toLowerCase()) {
            ...
            case "schemeqty":  
                ...
                break;
            case "schemeqtypro":  
                disposeSchemeQtyProWin();
                break;
            case "schprocatpro":  
                disposeSchProCatProWin();
                break;
            case "schemeprocat":  
                disposeSchemeProCatWin();
                break;
            case "slab":  
                disposeSlabWin();
                break;
