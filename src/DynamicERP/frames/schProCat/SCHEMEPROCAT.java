 ...
 */
package DynamicERP.frames.schProCat;
 ...
 * @author Shan
 */
public class SCHEMEPROCAT extends javax.swing.JFrame {

    /**
     * Creates new form SCHEMEPROCAT
     */
    ...
    public SCHEMEPROCAT() {
        ...
        try {
            ...
            Logger.getLogger(SCHEMEPROCAT.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        panelLayout.setHorizontalGroup(
            ...
            .addGroup(panelLayout.createSequentialGroup()
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnDuplicate, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(purchaseScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 356, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//*/
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
                    ...
                    for(int i=1;i<=productCount;i++){
                        if(purchaseProducts[i]!=null&&purchaseProducts[i].isDisplayable()){
                            ...
                            System.out.println("In");
                                ...
                                PAK_SCHEMEPROCAT_DB data1 =new PAK_SCHEMEPROCAT_DB();
                                Connection conn1;
                                try {
        ...
        //                                    data.find_max_in_purchase_products(conn1, invNo.getText()));
                                ...
                                if(isPresent){
                                   System.out.println(to.getText()+""+" UPDATE-> "+purchaseProducts[i].getSeqno().getText());
                                    ...
                                    PAK_SCHEMEPROCAT_DB data2 =new PAK_SCHEMEPROCAT_DB();
                                    Connection conn2;
                                    try {
        ...
        //                            Logger.getLogger(SCHEMEPROCAT.class.getName()).log(Level.SEVERE, null, ex);
                                    ...
                                    PAK_SCHEMEPROCAT_DB data3 =new PAK_SCHEMEPROCAT_DB();
                                    Connection conn3;
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCHEMEPROCAT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SCHEMEPROCAT().setVisible(true);
            }
        });
    }
