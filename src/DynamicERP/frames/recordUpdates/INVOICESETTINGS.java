    ...
    */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String[][] r = null;try {
                r = data.search_sailManPaid(conn, dcode.getText(), c.toDateString(dateIncrementer.addDays(dlDate.getDate(), 0).toString()),vanCode.getText());
            } catch (ParseException ex) {
                Logger.getLogger(INVOICESETTINGS.class.getName()).log(Level.SEVERE, null, ex);
            }if (r == null) {
        ...
        } catch (SQLException ex) {Logger.getLogger(INVOICESETTINGS.class.getName()).log(Level.SEVERE, null, ex);}
    ...
    private void vanNamePopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_vanNamePopupMenuWillBecomeVisible
        ...
        try {
            ...
            if(setSelectedComboItem(vanCode,vanName,((!vanCode.getText().isEmpty())?data.find_route_name_by_code(conn, vanCode.getText()):""))){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            ...
            try {
                conn = data.connect_database();
                data.update_sm_van_ob_date_Code(conn, rowData[i][0], rowData[i][3], rowData[i][4], rowData[i][6], rowData[i][8]);
    ...
    private void initTable(String[][] rowData) {
        String col[] = { "Doc. #", "Cust Code", "Name", "SM Code", "Van Code", "Van Name", "OBCode", "OB Name", "Date"};
        String row[][] = rowData;
