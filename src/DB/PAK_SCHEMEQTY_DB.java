 ...
 * @author Shan
 */
public class PAK_SCHEMEQTY_DB extends PAK_GLOBAL_DB{
    public ArrayList<String> get_last_purchase(Connection conn) throws SQLException {
        ...
        String Sql = "select * from SCHEMEQTY WHERE TONO="+max;
...
//        /*
	...
	java.sql.Statement statement = conn.createStatement();
	String Sql = "Select * from SCHEMEQTY";
       ...
       try
        {
            ...
            Sql="SELECT * FROM SCHEMEQTY WHERE TONO > "+Integer.parseInt(code)+" ORDER BY TONO";            
            ResultSet result = null;
            result=statement.executeQuery(Sql);
//            //System.out.println("Result : " + result);
       ...
       try
        {
            ...
            Sql="SELECT * FROM SCHEMEQTY WHERE TONO <"+Integer.parseInt(code)+" ORDER BY TONO DESC ";
...
//            //System.out.println("Result : " + result);
     ...
     public ArrayList<String> get_first_purchase(Connection conn)throws SQLException {
        ...
        if(min!=0){
            String Sql;
            Sql = "select * from SCHEMEQTY WHERE TONO="+min;//+"AND CREDITAMOUNT > "+Integer.parseInt("0");
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            //System.out.println("Result : " + result);
     ...
     public int find_min_in_purchase_code(Connection conn) {
        ...
        try
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql;
                Sql = "Select MIN(TO_NUMBER(TONO))as ID from SCHEMEQTY ";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHEMEQTY WHERE TONO = "+code;
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHEMEQTY WHERE TONO = '"+docno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHEMEQTY WHERE TONO = '"+docno+"' AND SRNO = '"+seqno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//            String s ="Seq # "+seqno+" Ref #";
    ...
    public ArrayList<String> find_purchase_by_code(Connection conn,String code) throws SQLException {
        java.sql.Statement statement = conn.createStatement();
        String Sql = "select * from SCHEMEQTY WHERE TONO="+code;
...
//            TONO,ODATE,REFNO,DESCR,TD,TC
             Sql="UPDATE SCHEMEQTY SET  REFNO = '"+refno+"', ODATE= TO_DATE('" + odate +
    ...
    public int find_max_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT MAX(SRNO) AS Count FROM SCHEMEQTY WHERE  TONO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
    ...
    public boolean insert_purchase_in_table(Connection conn,String docno,String odate,String refno,String descr,String td,String tc){
        ...
        try
        {
            ...
            String Sql = "INSERT INTO SCHEMEQTY(TONO,ODATE,REFNO,DESCR,TD,TC) VALUES ("
	...
	java.sql.Statement statement = conn.createStatement();
//         SELECT * FROM SCHEMEQTY WHERE  TONO = 90002 ORDER BY SRNO ASC
	String Sql = "SELECT * FROM SCHEMEQTY WHERE  TONO = '"+asset_rec+"' ORDER BY SRNO ASC";
	ResultSet resultset = statement.executeQuery(Sql);
        int i=0;
        while(resultset.next())
        {
     ...
     public int find_count_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(SRNO) AS Count FROM SCHEMEQTY WHERE  TONO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
     ...
     public boolean update_purchase_products_in_table_new(Connection conn,String tono,String pcode,String srno,String odate,String cdate,String stpcs,String endpcs,String unitd,String schrs){
        boolean var = false;
        try
        {
            ...
            //TONO,PCODE,SRNO,ODATE,CDATE,STPCS,ENDPCS,UNITD,SCHRS
                java.sql.Statement statement = conn.createStatement();
                String Sql;
                 Sql="UPDATE SCHEMEQTY SET TONO= '"+tono+"', PCODE = '"+pcode+"', SRNO = '"+srno+"', ODATE= TO_DATE('" + odate +
...
//            }
    ...
    public boolean check_product_line_item_presence_new(Connection conn,String string, String seqNoText,int pc) {
        ...
        try {
            ...
            Sql = "select * from SCHEMEQTY WHERE (TONO='"+string+"') AND (SRNO='"+seqNoText+"') ";
...
//                    System.out.println("MATCHED======with====="+seqNoText);
      ...
      public int find_max_in_purchase_code(Connection conn) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "Select MAX(TO_NUMBER(TONO))as ID from SCHEMEQTY";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("ID");
    ...
    public boolean insert_purchase_products_in_table(Connection conn,String tono,String pcode,String srno,String odate,String cdate,String stpcs,String endpcs,String unitd,String schrs){
        boolean var = false;
        try
        {
            java.sql.Statement statement = conn.createStatement();
            
            String Sql = "INSERT INTO SCHEMEQTY(TONO,PCODE,SRNO,ODATE,CDATE,STPCS,ENDPCS,UNITD,SCHRS) VALUES ('"+Float.parseFloat(tono)+"','"
...
//                cat=getPurchaseProducts(result);
            ...
            Logger.getLogger(PAK_SCHEMEQTY_DB.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cat;
    }
    ...
    public String[] get_accode_type_debit_credit(Connection conn1a, String s4, String s5) {
        ...
        try {
            ...
            String Sql = "select ACCODE,TYPE,DEBIT,CREDIT from SCHEMEQTY WHERE TONO ="+s4+" AND SRNO ="+s5;
    ...
    public boolean checkDates(Connection conn, String toDateString, String toDateString0, String to, String pcode) {
        boolean isValid=false;
        
        String cat[] = new String[4];
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select distinct TONO,ODATE,CDATE  from SCHEMEQTY WHERE PCODE ="+pcode;
     ...
     public boolean checkUpdDates(Connection conn, String toDateString, String toDateString0, String to, String pcode) {
        boolean isValid=false;
        
        String cat[] = new String[4];
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select distinct TONO,ODATE,CDATE  from SCHEMEQTY WHERE PCODE ="+pcode+" AND TONO <>"+to;
