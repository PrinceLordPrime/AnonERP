 ...
 * @author Shan
 */
public class PAK_SCHQTYPRO_DB extends PAK_GLOBAL_DB{
    public ArrayList<String> get_last_purchase(Connection conn) throws SQLException {
        ...
        String Sql = "select * from SCHQTYPRO WHERE TONO="+max;
...
//        /*
	...
	java.sql.Statement statement = conn.createStatement();
	String Sql = "Select * from SCHQTYPRO";
       ...
       try
        {
            ...
            Sql="SELECT * FROM SCHQTYPRO WHERE TONO > "+Integer.parseInt(code)+" ORDER BY TONO";            
            ResultSet result = null;
            result=statement.executeQuery(Sql);
//            //System.out.println("Result : " + result);
       ...
       try
        {
            ...
            Sql="SELECT * FROM SCHQTYPRO WHERE TONO <"+Integer.parseInt(code)+" ORDER BY TONO DESC ";
...
//            //System.out.println("Result : " + result);
     ...
     public ArrayList<String> get_first_purchase(Connection conn)throws SQLException {
        ...
        if(min!=0){
            String Sql;
            Sql = "select * from SCHQTYPRO WHERE TONO="+min;//+"AND CREDITAMOUNT > "+Integer.parseInt("0");
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            //System.out.println("Result : " + result);
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHQTYPRO WHERE TONO = "+code;
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHQTYPRO WHERE TONO = '"+docno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHQTYPRO WHERE TONO = '"+docno+"' AND SRNO = '"+seqno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//            String s ="Seq # "+seqno+" Ref #";
    ...
    public ArrayList<String> find_purchase_by_code(Connection conn,String code) throws SQLException {
        java.sql.Statement statement = conn.createStatement();
        String Sql = "select * from SCHQTYPRO WHERE TONO="+code;
...
//            TONO,ODATE,REFNO,DESCR,TD,TC
    ...
    public int find_max_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT MAX(SRNO) AS Count FROM SCHQTYPRO WHERE  TONO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
	...
	java.sql.Statement statement = conn.createStatement();
//         SELECT * FROM SCHQTYPRO WHERE  TONO = 90002 ORDER BY SRNO ASC
	String Sql = "SELECT * FROM SCHQTYPRO WHERE  TONO = '"+asset_rec+"' ORDER BY SRNO ASC";
	ResultSet resultset = statement.executeQuery(Sql);
        int i=0;
        while(resultset.next())
        {
     ...
     public int find_count_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(SRNO) AS Count FROM SCHQTYPRO WHERE  TONO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
...
//            }
    ...
    public boolean check_product_line_item_presence_new(Connection conn,String string, String seqNoText,int pc) {
        ...
        try {
            ...
            Sql = "select * from SCHQTYPRO WHERE (TONO='"+string+"') AND (SRNO='"+seqNoText+"') ";
...
//                    System.out.println("MATCHED======with====="+seqNoText);
    ...
    public boolean insert_purchase_products_in_table(Connection conn,String tono,String pcode,String srno,String odate,String cdate,String stpcs,String endpcs,String unitd,String schrs,String pro){
        boolean var = false;
        try
        {
            java.sql.Statement statement = conn.createStatement();
...
//                cat=getPurchaseProducts(result);
            ...
            Logger.getLogger(PAK_SCHQTYPRO_DB.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cat;
    }
    ...
    public String[] get_accode_type_debit_credit(Connection conn1a, String s4, String s5) {
        ...
        try {
            ...
            String Sql = "select ACCODE,TYPE,DEBIT,CREDIT from SCHQTYPRO WHERE TONO ="+s4+" AND SRNO ="+s5;
    ...
    public boolean checkDates(Connection conn, String toDateString, String toDateString0, String to, String pcode) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select distinct TONO,ODATE,CDATE  from SCHQTYPRO WHERE PCODE ="+pcode;
     ...
     public boolean checkUpdDates(Connection conn, String toDateString, String toDateString0, String to, String pcode) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select distinct TONO,ODATE,CDATE  from SCHQTYPRO WHERE PCODE ="+pcode+" AND TONO <>"+to;
