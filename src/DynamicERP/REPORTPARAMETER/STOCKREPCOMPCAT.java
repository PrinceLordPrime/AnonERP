 ...
 * @author DynamicSP
 */
public class STOCKREPCOMPCAT extends javax.swing.JFrame {
        ...
        parameterpanLayout.setHorizontalGroup(
            ...
            .addGroup(parameterpanLayout.createSequentialGroup()
                ...
                .addGroup(parameterpanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(companyname, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            try {
            String s= "D:\\DynamicERP\\DSP001\\stRepCompcatexpbatch.jasper";
       ...
       JasperPrint jasperPrint = net.sf.jasperreports.engine.JasperFillManager.fillReport(s, parametersMap, connAA);
        ...
        DynamicERP.dialoge.newdataentry.dialogeClass.disposeStockParameterWin();
        } else {}}
   ...
   DynamicERP.dialoge.newdataentry.dialogeClass.disposeStockParameterWin();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
            try {
            String s= "D:\\DynamicERP\\DSP001\\stockRepComp.jasper";
                    Map parametersMap = new HashMap();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(STOCKREPCOMPCAT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new STOCKREPCOMPCAT().setVisible(true);
            }
        });
    }
