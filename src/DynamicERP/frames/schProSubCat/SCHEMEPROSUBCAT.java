 ...
 */
package DynamicERP.frames.schProSubCat;

import DynamicERP.frames.schProCat.*;
import DynamicERP.frames.schems.*;
import DynamicERP.frames.paySeller.*;
import DB.PAK_DB;
import DB.PAK_SCHEMEPROSUBCAT_DB;
import DB.PAK_SCHEMEPROSUBCAT_DB;
 ...
 * @author Shan
 */
public class SCHEMEPROSUBCAT extends javax.swing.JFrame {

    /**
     * Creates new form SCHEMEPROSUBCAT
     */
    
    Conversions dateField=new Conversions();
    public SCHEMEPROSUBCAT() {
        initComponents();
        styleComboBox(pNames);
        ...
        try {
            ...
            Logger.getLogger(SCHEMEPROSUBCAT.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Category Scheme in Rs/- ");
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(605, 621));
        ...
        btnPrior.setPreferredSize(new java.awt.Dimension(85, 33));
        ...
        btnNext.setPreferredSize(new java.awt.Dimension(85, 33));
        ...
        panelLayout.setHorizontalGroup(
            ...
            .addGroup(panelLayout.createSequentialGroup()
                    ...
                    .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(panelLayout.createSequentialGroup()
                            ...
                            .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(panelLayout.createSequentialGroup()
                                        .addComponent(to, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(panelLayout.createSequentialGroup()
                                    ...
                                    .addGap(81, 81, 81))
                                .addComponent(unitDevisor, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(panelLayout.createSequentialGroup()
                            .addComponent(btnAddRow, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnDuplicate, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE))
                .addContainerGap())
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelLayout.createSequentialGroup()
                        ...
                        .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btnPrior, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(panelLayout.createSequentialGroup()
                        .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(btnAddRow, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(panelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(btnexit, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnSearchNow, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(purchaseScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 355, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
                /*
        try {
            dialogeClass.createViewSchemeProCatWin();
        } catch (SQLException ex) {
            Logger.getLogger(SCHEMEPROSUBCAT.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(DynamicERP.dialoge.viewforms.ViewForm1.isSaved){
            to.setText(dialogeClass.toSchemeProCat);
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        PAK_SCHEMEPROSUBCAT_DB data =new PAK_SCHEMEPROSUBCAT_DB();
        Connection conn;
        try {
...
//*/
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
                    ...
                    for(int i=1;i<=productCount;i++){
                        if(purchaseProducts[i]!=null&&purchaseProducts[i].isDisplayable()){
                            ...
                            System.out.println("In");
                                ...
                                PAK_SCHEMEPROSUBCAT_DB data1 =new PAK_SCHEMEPROSUBCAT_DB();
                                Connection conn1;
                                try {
        ...
        //                                    data.find_max_in_purchase_products(conn1, invNo.getText()));
                                ...
                                if(isPresent){
                                   System.out.println(to.getText()+""+" UPDATE-> "+purchaseProducts[i].getSeqno().getText());
                                    ...
                                    PAK_SCHEMEPROSUBCAT_DB data2 =new PAK_SCHEMEPROSUBCAT_DB();
                                    Connection conn2;
                                    try {
        ...
        //                            Logger.getLogger(SCHEMEPROSUBCAT.class.getName()).log(Level.SEVERE, null, ex);
                                    ...
                                    PAK_SCHEMEPROSUBCAT_DB data3 =new PAK_SCHEMEPROSUBCAT_DB();
                                    Connection conn3;
...
//                rate.setText(data.find_product_rate_by_code(conn, getCode(pNames.getSelectedItem().toString())));
    ...
    private void pCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pCodeKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                dialogeClass.createViewCatRecWin();
            } catch (SQLException ex) {
                Logger.getLogger(PakSchemeProCatFieldsPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
            if(DynamicERP.dialoge.viewforms.ViewForm.isSaved){
                pCode.setText(dialogeClass.codeCatRec);
            }else{
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCHEMEPROSUBCAT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SCHEMEPROSUBCAT().setVisible(true);
            }
        });
    }
    ...
    private static PakSchemeProCatFieldsPanel[] purchaseProducts = new PakSchemeProCatFieldsPanel[500];
...
//        pCode.setEditable(b);
    ...
    private void addRow() {
        ...
        purchaseProducts[productCount]=new PakSchemeProCatFieldsPanel();
