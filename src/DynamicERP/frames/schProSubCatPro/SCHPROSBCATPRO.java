 ...
 */
package DynamicERP.frames.schProSubCatPro;

import DynamicERP.frames.schProCatPro.*;
import DynamicERP.frames.schems.*;
import DynamicERP.frames.paySeller.*;
import DB.PAK_DB;
import DB.PAK_SCHPROSUBCATPRO_DB;
 ...
 * @author Shan
 */
public class SCHPROSBCATPRO extends javax.swing.JFrame {

    /**
     * Creates new form SCHPROSBCATPRO
     */
    
    Conversions dateField=new Conversions();
    public SCHPROSBCATPRO() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(SCHPROSBCATPRO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(588, 594));
        ...
        jLabel9.setText("Sub Category Scheme in Rs/- ");
                        ...
                        .addGroup(panelLayout.createSequentialGroup()
                            ...
                            .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelLayout.createSequentialGroup()
                                    .addComponent(unitDevisor, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
 ...
 //               /*
        try {
            dialogeClass.createViewSchProCatProWin();
        } catch (SQLException ex) {
            Logger.getLogger(SCHPROSBCATPRO.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(DynamicERP.dialoge.viewforms.ViewForm1.isSaved){
            to.setText(dialogeClass.toProCatPro);
...
//                */
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        PAK_SCHPROSUBCATPRO_DB data =new PAK_SCHPROSUBCATPRO_DB();
        Connection conn;
        try {
...
//                data.delete_all_suppS(conn, to.getText());
                setNullTextFields();
                try {
                    setLastRec();
                } catch (ParseException ex) {
...
//*/
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
                    ...
                    for(int i=1;i<=productCount;i++){
                        if(purchaseProducts[i]!=null&&purchaseProducts[i].isDisplayable()){
                            ...
                            System.out.println("In");
                                ...
                                PAK_SCHPROSUBCATPRO_DB data1 =new PAK_SCHPROSUBCATPRO_DB();
                                Connection conn1;
                                try {
        ...
        //                                    data.find_max_in_purchase_products(conn1, invNo.getText()));
                                ...
                                if(isPresent){
                                   System.out.println(to.getText()+""+" UPDATE-> "+purchaseProducts[i].getSeqno().getText());
                                    ...
                                    PAK_SCHPROSUBCATPRO_DB data2 =new PAK_SCHPROSUBCATPRO_DB();
                                    Connection conn2;
                                    try {
        ...
        //                            Logger.getLogger(SCHPROSBCATPRO.class.getName()).log(Level.SEVERE, null, ex);
                                    ...
                                    PAK_SCHPROSUBCATPRO_DB data3 =new PAK_SCHPROSUBCATPRO_DB();
                                    Connection conn3;
    ...
    private void pCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pCodeKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                Logger.getLogger(PakSchProSubCatProFieldsPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCHPROSBCATPRO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SCHPROSBCATPRO().setVisible(true);
            }
        });
    }
    ...
    private static PakSchProSubCatProFieldsPanel[] purchaseProducts = new PakSchProSubCatProFieldsPanel[500];
...
//        pCode.setEditable(b);
    ...
    private void addRow() {
        ...
        purchaseProducts[productCount]=new PakSchProSubCatProFieldsPanel();
