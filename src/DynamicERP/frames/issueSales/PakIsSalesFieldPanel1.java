...
import DynamicERP.frames.sales.PakSalesFieldPanel1;
 ...
 * @author Shan
 */
public class PakIsSalesFieldPanel1 extends javax.swing.JPanel {
...
//        KeyboardFocusManager.getCurrentKeyboardFocusManager().setDefaultFocusTraversalKeys(KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS, keys);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1147, 20));
        ...
        dmg.setBackground(new java.awt.Color(255, 255, 204));
        dmg.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        dmg.setText("0");
        dmg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dmgActionPerformed(evt);
            }
        });
        dmg.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                dmgKeyReleased(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ctn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(pcs, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                ...
                .addGap(0, 0, 0)
                .addComponent(dmg, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
    ...
    public JTextField getDmg() {
        return dmg;
    }

    public void setDmg(JTextField dmg) {
        this.dmg = dmg;
    }
...
//            }
    ...
    private void dmgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dmgActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_dmgActionPerformed

    private void dmgKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dmgKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_dmgKeyReleased
    ...
    private void DatePopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_DatePopupMenuWillBecomeVisible
        ...
        try {
            ...
            Date.setModel(PakSalesFieldPanel1.buildAllDtlComboBoxModel("date",seek.getText(),(Date.getSelectedItem()!=null?Date.getSelectedItem().toString():""),connAA));
    ...
    private void seekCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_seekCaretUpdate
        try {
            ...
            Logger.getLogger(PakIsSalesFieldPanel1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    ...
    public static DefaultComboBoxModel buildAllComboBoxModel() throws Exception {
        ...
        try {
            ...
            boolean tf=false;
            elements=data.find_all_product_name_size_by_code(connAA);
            if(elements!=null){    
...
//                J}OptionPane.showMessageDialog(j, "no Id Found");
    ...
    public static DefaultComboBoxModel buildOneDateComboBoxModel(String id,Connection cc) throws Exception {
        DefaultComboBoxModel comboBoxModel = new DefaultComboBoxModel();
        PAK_DB data =new PAK_DB();
        ...
        try {
            ...
            if(!id.equals("")){
                element=data.find_product_ExpDate_by_code(cc, id);
