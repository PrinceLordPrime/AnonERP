 ...
 * @author Shan
 */
public class SCHEMERS extends javax.swing.JFrame {

    /**
     * Creates new form SCHEMERS
     */
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Scheme Rs/- Management");
        ...
        panelLayout.setHorizontalGroup(
            ...
            .addGroup(panelLayout.createSequentialGroup()
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelLayout.createSequentialGroup()
                        .addGap(111, 111, 111)
                        .addComponent(pNames, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(panelLayout.createSequentialGroup()
                                ...
                                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(pCode, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//               /*
        try {
            dialogeClass.createViewSchemeRsWin();
        } catch (SQLException ex) {
            Logger.getLogger(SCHEMERS.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(DynamicERP.dialoge.viewforms.ViewForm1.isSaved){
            to.setText(dialogeClass.toRs);
...
//*/
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
                    ...
                    for(int i=1;i<=productCount;i++){
                        if(purchaseProducts[i]!=null&&purchaseProducts[i].isDisplayable()){
                            ...
                            System.out.println("In");
                                ...
                                PAK_SCHEMERS_DB data1 =new PAK_SCHEMERS_DB();
                                Connection conn1;
                                try {
        ...
        //                                    data.find_max_in_purchase_products(conn1, invNo.getText()));
                                ...
                                if(isPresent){
                                   System.out.println(to.getText()+""+" UPDATE-> "+purchaseProducts[i].getSeqno().getText());
                                    ...
                                    PAK_SCHEMERS_DB data2 =new PAK_SCHEMERS_DB();
                                    Connection conn2;
                                    try {
        ...
        //                            Logger.getLogger(SCHEMERS.class.getName()).log(Level.SEVERE, null, ex);
                                    ...
                                    PAK_SCHEMERS_DB data3 =new PAK_SCHEMERS_DB();
                                    Connection conn3;
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCHEMERS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
