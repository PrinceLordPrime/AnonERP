 ...
 */
public class ROUTEREC extends javax.swing.JFrame {

    /**
     * Creates new form ROUTEREC
     */
    public ROUTEREC() {
        initComponents();
        ...
        try {
            ...
            ArrayList<String> stock = data.get_first_route(conn);
            if(stock!=null){
                code.setText(stock.get(0));
                System.out.println("stock"+stock.get(1));
                route.setText(stock.get(1).trim());
            }else{
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Route,s Descriptions");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(code)
                            .addComponent(route, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        try {
            conn = data.connect_database();
            boolean tf=false;
            if(code.getText()==null||route.getText()==null){

            }else{
                
                if(data.chech_route(conn,code.getText())){
                    tf=data.delete_route(conn,code.getText(),route.getText());
                }else{
                    JFrame j1=new JFrame();
                    j1.setAlwaysOnTop(true);
                    JOptionPane.showMessageDialog(j1, "Route Present in Customer Record", "InfoBox: ", JOptionPane.INFORMATION_MESSAGE);
                }
            }
            if(tf){
                route.setText("");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(!(route.getText().toString().equalsIgnoreCase(""))){
            PAK_DB data =new PAK_DB();
            Connection conn;
            try {
                conn = data.connect_database();
                ...
                ///Max
                int max=0,codeInt=0;
                max=data.find_max_in_route_code(conn);
                ...
                tf=data.insert_route_rec_in_table(conn,String.valueOf(codeInt),route.getText());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            conn = data.connect_database();
            boolean tf=false;
            tf=data.update_route(conn,code.getText(),route.getText());
            if(tf){
                forBackBtnEnable(true);
                recEditBtnEnable(true);
                recEditActionBtnVisible(false);
...
//        /*
        try {
            dialogeClass.createViewRouteRecWin();
        } catch (SQLException ex) {
            Logger.getLogger(COMPANY.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(isSaved){
            code.setText(dialogeClass.codeRouteRec);
            route.setText(dialogeClass.routeRec);
        }else{
            //            JFrame j=new JFrame();
//                    j.setAlwaysOnTop(true);
...
//        */
    ...
    private void btnPriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPriorActionPerformed
        ...
        try {
            ...
            prior=data.prior_route(conn,code.getText());
            if(prior!=null){
                code.setText(prior.get(0));
                route.setText(prior.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        try {
            ...
            next=data.next_route(conn,code.getText(),route.getText());
            if(next!=null){
                code.setText(next.get(0));
                route.setText(next.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        DynamicERP.dialoge.newdataentry.dialogeClass.disposeRouteWin();
    ...
    private void btnSearchNowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchNowActionPerformed
        ...
        try {
            conn = data.connect_database();
            String s=data.find_route_rec_by_code(conn, code.getText());
            if (s!=null){
                route.setText(s);
                code.setEditable(false);
                forBackBtnEnable(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ROUTEREC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void setLastRec() {
        ...
        try {
            conn = data.connect_database();
            ArrayList<String> stock = data.get_last_route(conn);
            if(stock.get(0)==null){
                code.setText("");
                route.setText("");
            }else{
