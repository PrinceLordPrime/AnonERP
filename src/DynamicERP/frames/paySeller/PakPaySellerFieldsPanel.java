 ...
 * @author Shan
 */
public class PakPaySellerFieldsPanel extends javax.swing.JPanel {

    /**
     * Creates new form PakVocFieldsPanel
     */
    public PakPaySellerFieldsPanel() {
        initComponents();
        styleComboBox(type);
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(financeCode, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(financeName, 0, 272, Short.MAX_VALUE)
                .addGap(0, 0, 0)
...
//        setAllFieldData();
    ...
    private void financeCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_financeCodeKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                dialogeClass.createViewSupRecWin();
            } catch (SQLException ex) {
                Logger.getLogger(PakPaySellerFieldsPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
            if(DynamicERP.dialoge.viewforms.ViewForm1.isSaved){
                financeCode.setText(dialogeClass.codeSupRec);
            }else{
    ...
    }//GEN-LAST:event_financeCodeKeyPressed
