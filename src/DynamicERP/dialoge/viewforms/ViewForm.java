...
public class ViewForm extends javax.swing.JFrame implements KeyListener {
   ...
   public String getSearchFieldText() {
    ...
    public ViewForm(String col[],String string) {
            ...
            switch(type.toLowerCase()) {
                ...
                case "stloc":  
                        r=data.search_stloc_rec(conn, getSearchFieldText());
                         break;
                case "role":  
                        r=data.search_role_rec(conn, getSearchFieldText());
                         break;
                case "comp":  
...
//        });
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewForm(null,null).setVisible(true);
            }
        });
    }
