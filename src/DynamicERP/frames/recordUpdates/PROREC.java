 ...
 * @author Shan
 */
public class PROREC extends javax.swing.JFrame {
    ...
    */
            ...
            .addGroup(pan1Layout.createSequentialGroup()
                .addGroup(pan1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pan1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabel11))
                    .addComponent(dName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(5, 5, 5))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String[][] r = null;
                r = data.search_productRec(conn,dcode.getText());
                if (r == null) {
        ...
        } catch (SQLException ex) {Logger.getLogger(PROREC.class.getName()).log(Level.SEVERE, null, ex);}
    ...
    private void dNamePopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_dNamePopupMenuWillBecomeVisible
        ...
        try {
            conn = data.connect_database();
            dName.setModel(buildAllComboBoxModel("com"));
            if(setSelectedComboItem(dcode,dName,((!dcode.getText().isEmpty())?data.find_com_name_by_code(conn, dcode.getText()):""))){

            }else{
                dcode.setText(getCode(dName.getSelectedItem().toString(),"com"));
            }

            conn.close();
        } catch (SQLException ex) {
            Logger.getLogger(PROREC.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(PROREC.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void dcodeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dcodeKeyReleased
        try {
            updateComboBox(dcode, dName,"com");
        } catch (Exception ex) {
            Logger.getLogger(PROREC.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            ...
            try {
                conn = data.connect_database();
                data.update_pro_Code(conn, rowData[i][0], rowData[i][1], rowData[i][2], rowData[i][3], rowData[i][4], rowData[i][5], rowData[i][6], rowData[i][7], rowData[i][8], rowData[i][9]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PROREC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
    ...
    private void initTable(String[][] rowData) {
        String col[] = { "Code","Pname","Psize","Costprice","Saleprice","Retailprice"," Noofpcs"," Weight","Discper","Taxper"};
        String row[][] = rowData;
        ...
        jTable1=new JTable(model){private static final long serialVersionUID = 1L;
            @Override
            public boolean isCellEditable(int row, int col) {switch (col) {case 0:case 1:return false;default:return true;}}};
...
//                    JOptionPane.showMessageDialog(j, "Emter Id Found");
                    ...
                    case "com":
                        if(!name.equals("")){
                            s=data.find_com_name_by_code(conn,name);
                        }else{
                            comboBoxModel.addElement(name);
                        }
                        break;
