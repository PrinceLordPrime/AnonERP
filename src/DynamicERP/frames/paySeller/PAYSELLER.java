 ...
 */
package DynamicERP.frames.paySeller;
 ...
 * @author Shan
 */
public class PAYSELLER extends javax.swing.JFrame {

    /**
     * Creates new form PAYSELLER
     */
...
//      initScrollPanel();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Payments to Sellers");
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panelLayout.createSequentialGroup()
                        .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnLast, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnPrior, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnFirst, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(panelLayout.createSequentialGroup()
                        .addComponent(btnAddRow, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(75, 75, 75)
        ...
        panelLayout.setVerticalGroup(
            ...
            .addGroup(panelLayout.createSequentialGroup()
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnSearchNow, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        splPanelLayout.setHorizontalGroup(
            ...
            .addGroup(splPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(difference, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(purchaseScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//            dialogeClass.createViewSalesWin();
            dialogeClass.createViewPaySellerWin();
        } catch (SQLException ex) {
            Logger.getLogger(PAYSELLER.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(isSaved){
            invNo.setText(dialogeClass.codePaySeller);
...
//                */
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        PAK_PAYSELLER_DB data =new PAK_PAYSELLER_DB();
        Connection conn;
        try {
            ...
            if(invNo.getText()==null){
                ...
                for(int i=1;i<=productCount;i++){
                    if(purchaseProducts[i].isDisplayable()&& !purchaseProducts[i].getFinanceCode().getText().isEmpty()){
                        String purchaseProduct = data.get_clbal_from_supp(conn,purchaseProducts[i].getFinanceCode().getText());
                        if(purchaseProduct!=null){
                            ...
                            if(b!=null){
                                data.update_clbal_in_supp(conn,b+"",purchaseProducts[i].getFinanceCode().getText());
                            }
                        }
                    }
                }
...
/*
                                ...
                                try {
                                        tf=data.insert_suppleg_ledger(conn
                                                ,purchaseProducts[i].getFinanceCode().getText(),
                                                dateField.toDateString(oDate.getDate().toString()),
...
//                    JFrame j=new JFrame();
//            j.setAlwaysOnTop(true);
//            JOptionPane.showMessageDialog(j, "Leger Not Inserted ", "InfoBox: ", JOptionPane.INFORMATION_MESSAGE);
                }
...
//                                    data.find_max_in_purchase_products(conn1, invNo.getText()));
                        ...
                        if(isPresent){
                           System.out.println(invNo.getText()+""+" UPDATE-> "+purchaseProducts[i].getSeqno().getText());
    ...
    //                            int a=0;/ACCODE,TYPE,DEBIT,CREDI
        ...
        //                            
                                        ...
                                        case "Debit":
                                            if(s[0].equalsIgnoreCase(s0)&&s[1].equalsIgnoreCase("D")&&s[3].equalsIgnoreCase("0")&&s[2].equalsIgnoreCase(s23)){
                                                ...
                                                if(s[0].equalsIgnoreCase(s0)){
                                                    //============================FINANCE CLBAL===================================
                                                    String purchaseProduct = data2.get_clbal_from_supp(conn2,s0);
                                                    if(purchaseProduct!=null){
                                                        BigDecimal b=null;
                                                        b = ((new BigDecimal(purchaseProduct).add(new BigDecimal(s[3]))).subtract(new BigDecimal(s[2]))).add(new BigDecimal(s23));
                                                        if(b!=null){
                                                            data2.update_clbal_in_supp(conn2,b+"",s0);
                                                        }
                                                    }
                                                    //=========================================================================
                                                }else{
                                                 //============================FINANCE CLBAL===================================
                                                    String purchaseProduct = data2.get_clbal_from_supp(conn2,s[0]);
                                                    if(purchaseProduct!=null){
                                                        BigDecimal b=null;
                                                        b = (new BigDecimal(purchaseProduct).add(new BigDecimal(s[3]))).subtract(new BigDecimal(s[2]));
                                                        if(b!=null){
                                                            data2.update_clbal_in_supp(conn2,b+"",s[0]);
                                                        }
                                                    }
                                                    purchaseProduct = data2.get_clbal_from_supp(conn2,s0);
                                                    if(purchaseProduct!=null){
                                                        BigDecimal b=null;
                            ...
                            /*PAK_PAYSELLER_DB data3 =new PAK_PAYSELLER_DB();
                            Connection conn3;
                            try {//DOCNO,ACCODE,TYPE,AMOUNT,SEQNO
                                ...
                                String purchaseProduct = data3.get_clbal_from_supp(conn3,purchaseProducts[i].getFinanceCode().getText());
                                if(purchaseProduct!=null){
                                    BigDecimal b=null;
                                    switch (purchaseProducts[i].getType().getSelectedItem().toString()) {
                                        case "Debit":
                                    ...
                                    if(b!=null){
                                        data3.update_clbal_in_supp(conn3,b+"",purchaseProducts[i].getFinanceCode().getText());
                                    }
                                }
                                //=========================================================================  
                        ...
                        /*
                        //====================Finance(SUPPLEG) Update Start=========================
                        PAK_PAYSELLER_DB data4 =new PAK_PAYSELLER_DB();
                        Connection conn4;
                        try {//DOCNO,ACCODE,TYPE,AMOUNT,SEQNO
...
//                                System.out.println("====================="+s2);
                            if(data4.check_product_line_item_description_presence_new(conn4,invNo.getText(),s2)){
                                ...
                                switch (purchaseProducts[i].getType().getSelectedItem().toString()) {
                                    case "Debit":
                                        tf=data.insert_suppleg_ledger(conn4,
                                            purchaseProducts[i].getFinanceCode().getText(),
                                            dateField.toDateString(oDate.getDate().toString()),
                                            "Seq # "+purchaseProducts[i].getSeqno().getText()+" Ref # "+refNo.getText()+" against: "+remarks.getText(),
                                            purchaseProducts[i].getAmount().getText(),
...
//        editableProductPanel(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PAYSELLER.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private static PakPaySellerFieldsPanel[] purchaseProducts = new PakPaySellerFieldsPanel[500];
    private static PaySellerHeaderPanel purchaseHeaderPanel= new PaySellerHeaderPanel();
    ...
    private void addRow() {
        ...
        purchaseProducts[productCount]=new PakPaySellerFieldsPanel();
                    ...
                    JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){ //ConfermationDiloge()){
                        ...
                        try {
                            ...
                            if(s!=null){
                                if(s[0].equalsIgnoreCase(s0)){
                                    /*/============================FINANCE CLBAL===================================
                                    String purchaseProduct = data1.get_clbal_from_supp(conn1,s0);
                                    if(purchaseProduct!=null){
                                        BigDecimal b=null;
                                        b = ((new BigDecimal(purchaseProduct).add(new BigDecimal(s[3]))).subtract(new BigDecimal(s[2])));
                                        if(b!=null){
                                            data1.update_clbal_in_supp(conn1,b+"",s0);
                                        }
                                    }
                                    //=========================================================================*/
                                }else{
                                 /*/============================FINANCE CLBAL===================================
                                    String purchaseProduct = data1.get_clbal_from_supp(conn1,s[0]);
                                    if(purchaseProduct!=null){
                                        BigDecimal b=null;
                                        b = (new BigDecimal(purchaseProduct).add(new BigDecimal(s[3]))).subtract(new BigDecimal(s[2]));
                                        if(b!=null){
                                            data1.update_clbal_in_supp(conn1,b+"",s[0]);
                                        }
                                    }
                                    //=========================================================================  */
                                }
...
//          DOCNO,ACCODE,TYPE,AMOUNT,SEQNO
            System.out.println("isDisplayable ::::: "+purchaseProducts[i].isDisplayable());
            System.out.println("getFinanceCode :::: "+purchaseProducts[i].getFinanceCode().getText().isEmpty());
            if(purchaseProducts[i].isDisplayable()&& !purchaseProducts[i].getFinanceCode().getText().isEmpty()){
                String type="";
                    switch (purchaseProducts[i].getType().getSelectedItem().toString()) {
                        case "Debit":
