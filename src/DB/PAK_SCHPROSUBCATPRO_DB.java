 ...
 * @author Shan
 */
public class PAK_SCHPROSUBCATPRO_DB extends PAK_GLOBAL_DB{
    public ArrayList<String> get_last_purchase(Connection conn) throws SQLException {
        ...
        String Sql = "select * from SCHPROSUBCATPRO WHERE TONO="+max;
...
//        /*
	...
	java.sql.Statement statement = conn.createStatement();
	String Sql = "Select * from SCHPROSUBCATPRO";
       ...
       try
        {
            ...
            Sql="SELECT * FROM SCHPROSUBCATPRO WHERE TONO > "+Integer.parseInt(code)+" ORDER BY TONO";            
            ResultSet result = null;
            result=statement.executeQuery(Sql);
//            //System.out.println("Result : " + result);
       ...
       try
        {
            ...
            Sql="SELECT * FROM SCHPROSUBCATPRO WHERE TONO <"+Integer.parseInt(code)+" ORDER BY TONO DESC ";
...
//            //System.out.println("Result : " + result);
     ...
     public ArrayList<String> get_first_purchase(Connection conn)throws SQLException {
        ...
        if(min!=0){
            String Sql;
            Sql = "select * from SCHPROSUBCATPRO WHERE TONO="+min;//+"AND CREDITAMOUNT > "+Integer.parseInt("0");
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            //System.out.println("Result : " + result);
     ...
     public int find_min_in_purchase_code(Connection conn) {
        ...
        try
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql;
                Sql = "Select MIN(TO_NUMBER(TONO))as ID from SCHPROSUBCATPRO ";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHPROSUBCATPRO WHERE TONO = "+code;
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHPROSUBCATPRO WHERE TONO = '"+docno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM SCHPROSUBCATPRO WHERE TONO = '"+docno+"' AND SRNO = '"+seqno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//            String s ="Seq # "+seqno+" Ref #";
    ...
    public ArrayList<String> find_purchase_by_code(Connection conn,String code) throws SQLException {
        java.sql.Statement statement = conn.createStatement();
        String Sql = "select * from SCHPROSUBCATPRO WHERE TONO="+code;
...
//            TONO,ODATE,REFNO,DESCR,TD,TC
             Sql="UPDATE SCHPROSUBCATPRO SET  REFNO = '"+refno+"', ODATE= TO_DATE('" + odate +
    ...
    public int find_max_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT MAX(SRNO) AS Count FROM SCHPROSUBCATPRO WHERE  TONO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
    ...
    public boolean insert_purchase_in_table(Connection conn,String docno,String odate,String refno,String descr,String td,String tc){
        ...
        try
        {
            ...
            String Sql = "INSERT INTO SCHPROSUBCATPRO(TONO,ODATE,REFNO,DESCR,TD,TC) VALUES ("
	...
	java.sql.Statement statement = conn.createStatement();
//         SELECT * FROM SCHPROSUBCATPRO WHERE  TONO = 90002 ORDER BY SRNO ASC
	String Sql = "SELECT * FROM SCHPROSUBCATPRO WHERE  TONO = '"+asset_rec+"' ORDER BY SRNO ASC";
	ResultSet resultset = statement.executeQuery(Sql);
        int i=0;
        while(resultset.next())
        {
     ...
     public int find_count_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(SRNO) AS Count FROM SCHPROSUBCATPRO WHERE  TONO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
     ...
     public int find_count_in_purchase(Connection conn) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(TONO) AS Count FROM SCHPROSUBCATPRO";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
     ...
     public boolean update_purchase_products_in_table_new(Connection conn,String tono,String subcat,String srno,String odate,String cdate,String stpcs,String endpcs,String unitd,String schrs,String pcode1){
        boolean var = false;
        try
        {
            ...
            //TONO,SUBCAT,SRNO,ODATE,CDATE,STPCS,ENDPCS,UNITD,SCHRS
                java.sql.Statement statement = conn.createStatement();
                String Sql;
                 Sql="UPDATE SCHPROSUBCATPRO SET TONO= '"+tono+"', SUBCAT = '"+subcat+"', SRNO = '"+srno+"', ODATE= TO_DATE('" + odate +
                     "' , 'MM/DD/YY'),CDATE= TO_DATE('" + cdate +
                     "' , 'MM/DD/YY'),STPCS = '"+stpcs+"', ENDPCS = '"+endpcs+"', UNITD= '"+unitd+
                         "', SCHRS= '"+schrs+
                         "', PCODE1 = '"+pcode1+"' WHERE TONO ="+tono +"AND SRNO="+srno;
...
//            }
    ...
    public boolean check_product_line_item_presence_new(Connection conn,String string, String seqNoText,int pc) {
        ...
        try {
            ...
            Sql = "select * from SCHPROSUBCATPRO WHERE (TONO='"+string+"') AND (SRNO='"+seqNoText+"') ";
...
//                    System.out.println("MATCHED======with====="+seqNoText);
      ...
      public int find_max_in_purchase_code(Connection conn) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "Select MAX(TO_NUMBER(TONO))as ID from SCHPROSUBCATPRO";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("ID");
    ...
    public boolean insert_purchase_products_in_table(Connection conn,String tono,String subcat,String srno,String odate,String cdate,String stpcs,String endpcs,String unitd,String schrs,String pcode1){
        boolean var = false;
        try
        {
            java.sql.Statement statement = conn.createStatement();
            
            String Sql = "INSERT INTO SCHPROSUBCATPRO(TONO,SUBCAT,SRNO,ODATE,CDATE,STPCS,ENDPCS,UNITD,SCHRS,PCODE1) VALUES ('"+Float.parseFloat(tono)+"','"
                    + Integer.parseInt(subcat)+"','" + Integer.parseInt(srno)+ "',TO_DATE('"+odate+"' ,'MM/DD/YY'),TO_DATE('"+cdate+"' ,'MM/DD/YY'),'"
                    +Float.parseFloat(stpcs)+"','"+Float.parseFloat(endpcs)+"','"+Float.parseFloat(unitd)+"','"+Float.parseFloat(schrs)+"','"
                    + Integer.parseInt(pcode1)+"')";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//          ,,,,,,,,
            ...
            String code = result.getString("TONO");
                ...
                String add141 = result.getString("PCODE1");
                cat.add(0,code );//to
                cat.add(1,c );//subcat
                cat.add(2,co );//srno
                cat.add(3,ad2 );//odate
...
//                cat=getPurchaseProducts(result);
            ...
            Logger.getLogger(PAK_SCHPROSUBCATPRO_DB.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cat;
    }
    ...
    public String find_product_name_by_code(Connection conn, String code) throws SQLException {
        ...
        if(result.next()){
            ...
            System.out.println("result.getString(\"NAME\")"+result.getString("SUBCAT"));
        }else{
            cat=null;
        }
        return cat;
    ...
    public ArrayList<String> find_all_product_name_size_by_code(Connection conn) throws SQLException {
       ...
       String Sql = "Select * from SUBCAT ORDER BY lower(SUBCAT) ASC";
	ResultSet resultset = statement.executeQuery(Sql);
        int i=0;
        while(resultset.next())
        {           
                cat.add(i,resultset.getString("SUBCAT"));
                //System.out.println("NAME: " + resultset.getString("SUBCAT").toString());
                i++;
                //returned=null;
        }
        return cat;
    ...
    public String[] get_accode_type_debit_credit(Connection conn1a, String s4, String s5) {
        ...
        try {
            ...
            String Sql = "select ACCODE,TYPE,DEBIT,CREDIT from SCHPROSUBCATPRO WHERE TONO ="+s4+" AND SRNO ="+s5;
    ...
    public boolean checkDates(Connection conn, String toDateString, String toDateString0, String to, String subcat) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select distinct TONO,ODATE,CDATE  from SCHPROSUBCATPRO WHERE SUBCAT ="+subcat;
    ...
    public boolean checkUpdDates(Connection conn, String toDateString, String toDateString0, String to, String subcat) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select distinct TONO,ODATE,CDATE  from SCHPROSUBCATPRO WHERE SUBCAT ="+subcat+" AND TONO <>"+to;
