 ...
 * @author Shan
 */
public class SCHEMEQTY extends javax.swing.JFrame {

    /**
     * Creates new form SCHEMEQTY
     */
...
//      initScrollPanel();
        ...
        try {
            ...
            Logger.getLogger(SCHEMEQTY.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Scheme Qty Management");
...
//               /*
        try {
            dialogeClass.createViewSchemeQtyWin();
        } catch (SQLException ex) {
            Logger.getLogger(SCHEMERS.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(DynamicERP.dialoge.viewforms.ViewForm1.isSaved){
            to.setText(dialogeClass.toQty);
...
//                */
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        PAK_SCHEMEQTY_DB data =new PAK_SCHEMEQTY_DB();
        Connection conn;
        try {
...
//*/
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
                    ...
                    for(int i=1;i<=productCount;i++){
                        if(purchaseProducts[i]!=null&&purchaseProducts[i].isDisplayable()){
                            ...
                            System.out.println("In");
                                ...
                                PAK_SCHEMEQTY_DB data1 =new PAK_SCHEMEQTY_DB();
                                Connection conn1;
                                try {
        ...
        //                                    data.find_max_in_purchase_products(conn1, invNo.getText()));
                                ...
                                if(isPresent){
                                   System.out.println(to.getText()+""+" UPDATE-> "+purchaseProducts[i].getSeqno().getText());
                                    ...
                                    PAK_SCHEMEQTY_DB data2 =new PAK_SCHEMEQTY_DB();
                                    Connection conn2;
                                    try {
        ...
        //                            Logger.getLogger(SCHEMEQTY.class.getName()).log(Level.SEVERE, null, ex);
                                    ...
                                    PAK_SCHEMEQTY_DB data3 =new PAK_SCHEMEQTY_DB();
                                    Connection conn3;
    ...
    private void pCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pCodeKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                Logger.getLogger(PakSchemeRsFieldsPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCHEMEQTY.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
