 ...
 */
public class SATELMENTTYPE extends javax.swing.JFrame {

    /**
     * Creates new form ZONEREC
     */
    public SATELMENTTYPE() {
        initComponents();
        ...
        try {
            ...
            ArrayList<String> stock = data.get_first_satelment(conn);
            if(stock!=null){
...
//        */
    ...
    private void btnPriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPriorActionPerformed
        ...
        try {
            ...
            prior=data.prior_satelment(conn,code.getText(),zone.getText());
            if(prior!=null){
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        try {
            ...
            next=data.next_satelment(conn,code.getText(),zone.getText());
            if(!(next==null)){
...
javax.swing.JFrame j=new javax.swing.JFrame(); j.setAlwaysOnTop(true);if(JOptionPane.showConfirmDialog(j,
        ...
        try {
            ...
            if(code.getText()==null||zone.getText()==null){
                ...
                if(data.chech_satelment(conn,code.getText())){
                    tf=data.delete_satelment(conn,code.getText(),zone.getText());
                }else{
                    JFrame j1=new JFrame();
                    j1.setAlwaysOnTop(true);
                    JOptionPane.showMessageDialog(j1, "Not Deleted...! Sattlement Type Present in Sattlement ", "InfoBox: ", JOptionPane.INFORMATION_MESSAGE);
                }
            }
            if(tf){
                zone.setText("");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
               DynamicERP.dialoge.newdataentry.dialogeClass.disposeSettlementType();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(!(zone.getText().toString().equalsIgnoreCase(""))){
            ...
            try {
                ...
                ///Max
                int max=0,codeInt=0;
                max=data.find_max_in_satelment_code(conn);
                ...
                tf=data.insert_satelment_rec_in_table(conn,String.valueOf(codeInt),zone.getText());
    ...
    private void btnSearchNowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchNowActionPerformed
        ...
        try {
            conn = data.connect_database();
            String s=data.find_satelment_rec_by_code(conn, code.getText());
            if (s!=null){
                zone.setText(s);
                code.setEditable(false);
                forBackBtnEnable(true);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            conn = data.connect_database();
            boolean tf=false;
            tf=data.update_satelment(conn,code.getText(),zone.getText());
            if(tf){
                zone.setEditable(false);
                forBackBtnEnable(true);
                recEditBtnEnable(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SATELMENTTYPE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SATELMENTTYPE().setVisible(true);
            }
        });
    }
    ...
    private void setLastRec() {
        ...
        try {
            conn = data.connect_database();
            ArrayList<String> stock = data.get_last_satelment(conn);
            if(stock.get(0)==null){
                code.setText("");
                zone.setText("");
            }else{
