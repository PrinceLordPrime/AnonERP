...
public class ASSETTYPE extends javax.swing.JFrame {
    ...
    public ASSETTYPE() {
        ...
        try {
            ...
            ArrayList<String> stock = data.get_first_loc(conn);
            if(stock!=null){
                code.setText(stock.get(0));
                Block.setText(stock.get(1));
            }else{
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Asset Type's Records");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Block, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Block, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel2, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//        /*
        try {
            ...
            dialogeClass.createViewStLocWin();
            
        } catch (SQLException ex) {
            Logger.getLogger(COMPANY.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(isSaved){
            code.setText(dialogeClass.codeStLoc);
            Block.setText(dialogeClass.stLoc);
        }else{
            //            JFrame j=new JFrame();
//                    j.setAlwaysOnTop(true);
...
//        */
    ...
    if(!(code.getText().toString().equalsIgnoreCase(""))){
        ...
        try {
            conn = data.connect_database();
            String s=data.find_loc_rec_by_code(conn, code.getText());
            if (s!=null){
                Block.setText(s);
                code.setEditable(false);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(!(Block.getText().toString().equalsIgnoreCase(""))){
            PAK_DB data =new PAK_DB();
            Connection conn;
            try {
                conn = data.connect_database();
                ...
                ///Max
                int max=0,codeInt=0;
                max=data.find_max_in_loc_code(conn);
                ...
                tf=data.insert_asset_type_in_table(conn,String.valueOf(codeInt),Block.getText());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            conn = data.connect_database();
            boolean tf=false;
            tf=data.update_asset_type(conn,code.getText(),Block.getText());
            if(tf){
                Block.setEditable(false);
                forBackBtnEnable(true);
                recEditBtnEnable(true);
    ...
    private void btnPriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPriorActionPerformed
        ...
        try {
            ...
            prior=data.prior_loc(conn,code.getText(),Block.getText());
            if(!(prior==null)){
                code.setText(prior.get(0));
                Block.setText(prior.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        try {
            ...
            next=data.next_loc(conn,code.getText(),Block.getText());
            if(!(next==null)){
                code.setText(next.get(0));
                Block.setText(next.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    private void exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitActionPerformed
        DynamicERP.dialoge.newdataentry.dialogeClass.disposeAssetTypeWin();
...
//            }else{
                ...
                { //ConfermationDiloge()){
                    ...
                    //        PAK_DB data =new PAK_DB();
                    boolean tf=false;
                    if(code.getText()==null||Block.getText()==null){

                    }else{
                        tf=data.delete_loc(conn,code.getText(),Block.getText());
                    }
                    if(tf){
                        Block.setText("");
                        code.setText("");
...
//            }
    ...
    private void BlockKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BlockKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
                    btnSave.requestFocus();
                    btnUpdate.requestFocus();
                        
        }      
         }//GEN-LAST:event_BlockKeyPressed
    ...
    private void setLastRec() {
        ...
        try {
            conn = data.connect_database();
            ArrayList<String> stock = data.get_last_loc(conn);
            if(stock.get(0)==null){
                code.setText("");
                Block.setText("");
            }else{
