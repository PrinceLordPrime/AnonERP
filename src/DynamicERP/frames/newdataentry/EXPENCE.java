...
public class EXPENCE extends javax.swing.JFrame {
    ...
    public EXPENCE() {
        ...
        try {
            ...
            ArrayList<String> stock = data.get_first_exp(conn);
            if(stock!=null){
                code.setText(stock.get(0));
                exp.setText(stock.get(1));
            }else{
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Expence Account:");
        ...
        jLabel4.setText("Expence Account Records");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(code, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(!(exp.getText().toString().equalsIgnoreCase(""))){
            PAK_DB data =new PAK_DB();
            Connection conn;
            try {
                conn = data.connect_database();
                ...
                ///Max
                int max=0,codeInt=0;
                max=data.find_max_in_exp_code(conn);
                ...
                tf=data.insert_exp_rec_in_table(conn,String.valueOf(codeInt),exp.getText());
    ...
    if(!(code.getText().toString().equalsIgnoreCase(""))){
        ...
        try {
            conn = data.connect_database();
            String s=data.find_exp_rec_by_code(conn, code.getText());
            if (s!=null){
                exp.setText(s);
                code.setEditable(false);
                forBackBtnEnable(true);
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        try {
            ...
            Connection conn;
            conn = data.connect_database();
            if(data.check_expence_dep_code_presence_in_expence(conn,code.getText())){
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
                ...
                { //ConfermationDiloge()){
                    ...
                    code.getText();
                    boolean tf=false;
                    if(code.getText()==null||exp.getText()==null){

                    }else{
                        tf=data.delete_exp(conn,code.getText());
                    }
                    if(tf){
                        exp.setText("");
                        code.setText("");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            conn = data.connect_database();
            boolean tf=false;
            tf=data.update_exp(conn,code.getText(),exp.getText());
            if(tf){
                forBackBtnEnable(true);
                recEditBtnEnable(true);
                recEditActionBtnVisible(false);
...
//        /*
        try {
            dialogeClass.createViewExpenceWin();
        } catch (SQLException ex) {
            Logger.getLogger(COMPANY.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(isSaved){
            code.setText(dialogeClass.codeExpence);
            exp.setText(dialogeClass.expence);
        }else{
            //            JFrame j=new JFrame();
//                    j.setAlwaysOnTop(true);
...
//        */
    ...
    private void btnPriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPriorActionPerformed
        ...
        try {
            ...
            prior=data.prior_exp(conn,code.getText(),exp.getText());
            if(!(prior==null)){
                code.setText(prior.get(0));
                exp.setText(prior.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        try {
            ...
            next=data.next_exp(conn,code.getText(),exp.getText());
            if(!(next==null)){
                code.setText(next.get(0));
                exp.setText(next.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
         DynamicERP.dialoge.newdataentry.dialogeClass.disposeExpenceWin();
    ...
    private void setLastRec() {
        ...
        try {
            conn = data.connect_database();
            ArrayList<String> stock = data.get_last_exp(conn);
            if(stock.get(0)==null){
                code.setText("");
                exp.setText("");
            }else{
