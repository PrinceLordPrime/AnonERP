 ...
 */
package DynamicERP.frames.schProCatPro;

import DynamicERP.frames.schems.*;
import DynamicERP.frames.paySeller.*;
import DB.PAK_DB;
import DB.PAK_SCHPROCATPRO_DB;
 ...
 * @author Shan
 */
public class SCHPROCATPRO extends javax.swing.JFrame {

    /**
     * Creates new form SCHPROCATPRO
     */
    ...
    public SCHPROCATPRO() {
        ...
        try {
            ...
            Logger.getLogger(SCHPROCATPRO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        panelLayout.setHorizontalGroup(
            ...
            .addGroup(panelLayout.createSequentialGroup()
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(btnDuplicate, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
...
//                */
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        PAK_SCHPROCATPRO_DB data =new PAK_SCHPROCATPRO_DB();
        Connection conn;
        try {
...
//*/
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
                    ...
                    for(int i=1;i<=productCount;i++){
                        if(purchaseProducts[i]!=null&&purchaseProducts[i].isDisplayable()){
                            ...
                            System.out.println("In");
                                ...
                                PAK_SCHPROCATPRO_DB data1 =new PAK_SCHPROCATPRO_DB();
                                Connection conn1;
                                try {
        ...
        //                                    data.find_max_in_purchase_products(conn1, invNo.getText()));
                                ...
                                if(isPresent){
                                   System.out.println(to.getText()+""+" UPDATE-> "+purchaseProducts[i].getSeqno().getText());
                                    ...
                                    PAK_SCHPROCATPRO_DB data2 =new PAK_SCHPROCATPRO_DB();
                                    Connection conn2;
                                    try {
        ...
        //                            Logger.getLogger(SCHPROCATPRO.class.getName()).log(Level.SEVERE, null, ex);
                                    ...
                                    PAK_SCHPROCATPRO_DB data3 =new PAK_SCHPROCATPRO_DB();
                                    Connection conn3;
    ...
    private void pCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pCodeKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                Logger.getLogger(PakSchProCatProFieldsPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCHPROCATPRO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SCHPROCATPRO().setVisible(true);
            }
        });
    }
    ...
    private static PakSchProCatProFieldsPanel[] purchaseProducts = new PakSchProCatProFieldsPanel[500];
...
//        pCode.setEditable(b);
    ...
    private void addRow() {
        ...
        purchaseProducts[productCount]=new PakSchProCatProFieldsPanel();
