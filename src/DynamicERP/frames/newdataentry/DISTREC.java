...
import static DynamicERP.dialoge.viewforms.dialogeClass.createViewDistRecWin;

/**
 *
 * @author UzairYousafZai
 */
public class DISTREC extends javax.swing.JFrame {

    /**
     * Creates new form DISTREC
     */
    public DISTREC() {
        initComponents();
        ...
        try {
            ...
            ArrayList<String> stock = data.get_first_dist(conn);
            if(stock!=null)
            {
                code.setText(stock.get(0));
                dist.setText(stock.get(1));
            }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("District's Records");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(code)
                            .addComponent(dist, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnPriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPriorActionPerformed
        ...
        try {
            ...
            prior=data.prior_dist(conn,code.getText(),dist.getText());
            if(!(prior==null)){
                code.setText(prior.get(0));
                dist.setText(prior.get(1));
            }else{
                JFrame j=new JFrame();
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        try {
            ...
            next=data.next_dist(conn,code.getText(),dist.getText());
            if(!(next==null)){
                code.setText(next.get(0));
                dist.setText(next.get(1));
            }else{
                JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
                 DynamicERP.dialoge.newdataentry.dialogeClass.disposeDistrecWin();
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        try {
            conn = data.connect_database();
            boolean tf=false;
            if(code.getText()==null||dist.getText()==null){

            }else{
                tf=data.delete_dist(conn,code.getText(),dist.getText());
            }
            if(tf){
                dist.setText("");
                code.setText("");
...
//        /*
        try {
            createViewDistRecWin();
        } catch (SQLException ex) {
            Logger.getLogger(COMPANY.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(isSaved){
            code.setText(dialogeClass.codeDistRec);
            dist.setText(dialogeClass.distRec);
        }else{
            JFrame j=new JFrame();
                    j.setAlwaysOnTop(true);
...
//        */
    ...
    private void btnSearchNowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchNowActionPerformed
        ...
        try {
            conn = data.connect_database();
            String s=data.find_dist_rec_by_code(conn, code.getText());
            if (s!=null){
                dist.setText(s);
                code.setEditable(false);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(!(dist.getText().toString().equalsIgnoreCase(""))){
            ...
            try {
                ...
                ///Max
                int max=0,codeInt=0;
                max=data.find_max_in_dist_code(conn);
                ...
                tf=data.insert_dist_rec_in_table(conn,String.valueOf(codeInt),dist.getText());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            conn = data.connect_database();
            boolean tf=false;
            tf=data.update_dist(conn,code.getText(),dist.getText());
            if(tf){
                dist.setEditable(false);
                forBackBtnEnable(true);
                recEditBtnEnable(true);
...
private void enableFields(javax.swing.JFrame aThis, boolean b) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DISTREC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void setLastRec() {
        ...
        try {
            conn = data.connect_database();
            ArrayList<String> stock = data.get_last_dist(conn);
            if(stock.get(0)==null){
                code.setText("");
                dist.setText("");
            }else{
