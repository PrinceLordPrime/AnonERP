 ...
 * @author Shan
 */
public class PAK_QUOTATION_DB extends PAK_GLOBAL_DB{
    ...
    public String get_perqty_wrt_perdtl_code_seek(Connection conn, String a, String b) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select * from QUOTATIONDTL WHERE PCODE="+a+" AND DOCNO ="+b;
    ...
    public String check_product_line_item_presence_with_seek(Connection conn,String string, String seqNoText,String seekText,int pc) {
        ...
        try {
            ...
            String Sql = null;
            Sql = "select * from QUOTATIONDTL WHERE (DOCNO='"+string+"') AND (SEQNO='"+seqNoText+"') ";
...
//                }
    ...
    public ArrayList<String> get_last_purchase(Connection conn) throws SQLException {
        ...
        String Sql = "select * from QUOTATIONMAIN WHERE DOCNO="+max;
...
//        /*
	...
	java.sql.Statement statement = conn.createStatement();
	String Sql = "Select * from QUOTATIONMAIN";
       ...
       try
        {
            ...
            Sql="SELECT * FROM QUOTATIONMAIN WHERE DOCNO > "+Integer.parseInt(code)+" ORDER BY DOCNO";            
            ResultSet result = null;
            result=statement.executeQuery(Sql);
//            //System.out.println("Result : " + result);
       ...
       try
        {
            ...
            Sql="SELECT * FROM QUOTATIONMAIN WHERE DOCNO <"+Integer.parseInt(code)+" ORDER BY DOCNO DESC ";
...
//            //System.out.println("Result : " + result);
     ...
     public ArrayList<String> get_first_purchase(Connection conn)throws SQLException {
        ...
        if(min!=0){
            String Sql;
            Sql = "select * from QUOTATIONMAIN WHERE DOCNO="+min;//+"AND CREDITAMOUNT > "+Integer.parseInt("0");
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            //System.out.println("Result : " + result);
     ...
     public int find_min_in_purchase_code(Connection conn) {
        ...
        try
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql;
                Sql = "Select MIN(TO_NUMBER(DOCNO))as ID from QUOTATIONMAIN ";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM QUOTATIONMAIN WHERE DOCNO = "+code;
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM QUOTATIONDTL WHERE DOCNO = '"+docno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
...
//        DELETE FROM emp WHERE empno = my_empno
        ...
        try
        {
            ...
            Sql = "DELETE FROM QUOTATIONDTL WHERE DOCNO = '"+docno+"' AND SEQNO = '"+seqno+"'";
            statement.executeUpdate(Sql);
            var = true;
        }
        catch(SQLException e)
    ...
    public ArrayList<String> find_purchase_by_code(Connection conn,String code) throws SQLException {
        java.sql.Statement statement = conn.createStatement();
        String Sql = "select * from QUOTATIONMAIN WHERE DOCNO="+code;
...
//PAID,REMARKS,NETPAYABLE,DCODE
             Sql="UPDATE QUOTATIONMAIN SET AVDISCPER= '"+avdiscper+"', REFNO = '"+refno+"', CUSTCODE = '"+supcode+
    ...
    public int find_max_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT MAX(SEQNO) AS Count FROM QUOTATIONDTL WHERE  DOCNO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
    ...
    public boolean insert_purchase_in_table(Connection conn,  String odate,String  docno,String  refno,String  supcode,
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "INSERT INTO QUOTATIONMAIN(ODATE,DOCNO,REFNO,CUSTCODE,TGROSSAMT,SPLPER,SPLRS,OTHEREXP,AVDISCPER,"
	...
	java.sql.Statement statement = conn.createStatement();
//         SELECT * FROM QUOTATIONDTL WHERE  DOCNO = 90002 ORDER BY SEQNO ASC
	String Sql = "SELECT * FROM QUOTATIONDTL WHERE  DOCNO = '"+asset_rec+"' ORDER BY SEQNO ASC";
	ResultSet resultset = statement.executeQuery(Sql);
        int i=0;
        while(resultset.next())
        {         
     ...
     public int find_count_in_purchase_products(Connection conn, String name) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(SEQNO) AS Count FROM QUOTATIONDTL WHERE  DOCNO = '"+name+"'";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
     ...
     public int find_count_in_purchase(Connection conn) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = " SELECT COUNT(DOCNO) AS Count FROM QUOTATIONMAIN";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("Count");
...
//            if(check_product_line_item_presence_new(conn, docno, seqno)){
                java.sql.Statement statement = conn.createStatement();
                String Sql;
                 Sql="UPDATE QUOTATIONDTL SET SEQNO= '"+seqno+"', PCODE = '"+pcode+"', SALEQTY = '"+perqty+
...
//            }
    ...
    public boolean check_product_line_item_presence_new(Connection conn,String string, String seqNoText,int pc) {
        ...
        try {
            ...
            String Sql = "select * from QUOTATIONDTL ";
            result=statement[Integer.parseInt(seqNoText)].executeQuery(Sql);
            Sql = "select * from QUOTATIONDTL WHERE (DOCNO='"+string+"') AND (SEQNO='"+seqNoText+"') ";
    ...
    public int find_max_in_purchase_code(Connection conn) {
        ...
        {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "Select MAX(TO_NUMBER(DOCNO))as ID from QUOTATIONMAIN";
            ResultSet result = null;
            result=statement.executeQuery(Sql);
            result.next();
            String temp=result.getString("ID");
...
//DOCNO,SEQNO,PCODE,SALEQTY,SALERATE,GROSSAMOUNT,DISCPER,DISCRS,TAXPER,TAXRS,NETAMOUNT,
            ...
            String Sql = "INSERT INTO QUOTATIONDTL(DOCNO,SEQNO,PCODE,SALEQTY,SALERATE,GROSSAMOUNT,DISCPER,DISCRS,TAXPER,"
                    + "TAXRS,NETAMOUNT,DMG,FREE,CUSTOMSIZE) VALUES ('"+ Integer.parseInt(docno)+"','" + Integer.parseInt(seqno)+ "','"
                    ...
                    + "','"+Float.parseFloat(taxper)+"','"+Float.parseFloat(taxrs)+"','"
                    +Float.parseFloat(netamount)+ "','"
                    +Float.parseFloat(dmg)+ "','"
...
//                cat=getPurchase(result);
            ...
            Logger.getLogger(PAK_QUOTATION_DB.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cat;
    }
    ...
    public String[] get_invNo_clientCode_remaining(Connection conn, String string) {
        ...
        try {
            java.sql.Statement statement = conn.createStatement();
            String Sql = "select * from QUOTATIONMAIN WHERE DOCNO ="+string;
